      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-md-6 cell">
						<a class="btn" href="request-a-fundraiser" role="button">
							<img class="" src="<?php echo get_theme_file_uri( 'img/home-jumbotron-start.svg' );?>" alt="" title="" />
						</a>
        		<p class="lbl"><a class="btn btn-primary btn-lg btn-home" href="request-a-fundraiser" role="button">Start a Campaign</a></p>
        	</div> <!-- /column -->
        	<div class="col-md-6 cell">
						<a class="btn" href="organizations" role="button">
							<img class="" src="<?php echo get_theme_file_uri( 'img/home-jumbotron-find.svg' );?>" alt="" title="" />
						</a>
        		<p class="lbl"><a class="btn btn-primary btn-lg btn-home" href="organizations" role="button">Find a Campaign</a></p>
        	</div> <!-- /column -->
        </div> <!-- /row -->
        ...
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<p class="step-copy">Once the group’s UFund website is up and running, UFund will release the URL address to the organization. Then all of the organization’s members will be asked to share that particular website with all of their friends and family via social media. The more people each member shares it with, the more money the group will raise.</p>
						</div>
					</div>
        </div> <!-- /column -->
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<p class="step-copy">Each fundraiser lasts for 2 weeks (and can be extended for a week if the organization requests it). The fundraiser will then close, and UFund will give the group a detailed report on all purchases made, so your fundraising team can celebrate! At the time of checkout, each customer will provide their mailing address and their products will be shipped directly to them. UFund will take 100% of the work out of having to deliver any products!</p>
						</div>
					</div>
        </div> <!-- /column -->
        <div class="col-md-3">
