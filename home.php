      ...
      <div class="container">
        ...
        <div class="row">
        	<div class="col-md-6 cell">
        		...
        		<p>
        		  <a class="btn btn-primary btn-lg btn-home" href="request-a-fundraiser" role="button">Start a Campaign</a>
        		</p>
        	</div> <!-- /column -->
        	<div class="col-md-6 cell">
        		...
        		<p>
        		  <a class="btn btn-primary btn-lg btn-home" href="organizations" role="button">Find a Campaign</a>
        		</p>
        	</div> <!-- /column -->
        </div> <!-- /row -->
