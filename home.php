...
<?php get_sidebar('left'); ?>
        ...
        <div class="row">
        	<div class="col-md-6 cell">
						<a class="btn" href="template-form-campaign-start.html" role="button">
							<img class="" src="img/home-jumbotron-start.svg" alt="" title="" />
						</a>
        	...
        	<div class="col-md-6 cell">
						<a class="btn" href="template-page-campaign-find.html" role="button">
							<img class="" src="img/home-jumbotron-find.svg" alt="" title="" />
						</a>
    ...
    <div class="container">
      ...
      <div class="row work-intro">
        <div class="col-md-12">
          <h2>How it Works</h2>
        	<img class="step-img" src="img/home-howitworks-0.svg" alt="" title="" />
        ...
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<img class="step-img" src="img/home-howitworks-1.svg" alt="" title="" />
							<h2>Heading</h2>
        ...
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<img class="step-img" src="img/home-howitworks-2.svg" alt="" title="" />
							<h2>Heading</h2>
        ...
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<img class="step-img" src="img/home-howitworks-3.svg" alt="" title="" />
							<h2>Heading</h2>
        ...
        <div class="col-md-3">
					<div class="panel panel-default step">
						<div class="panel-body">
							...
							<img class="step-img" src="img/home-howitworks-4.svg" alt="" title="" />
							<h2>Heading</h2>
